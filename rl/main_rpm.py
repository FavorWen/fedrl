...
# nohup python main_rpm.py --history_dim 4 --client_nums 5 --participant_nums 3 --seed 5 --dataset MNIST --arch MLP --partition iid --optimizer SGD  --lr 0.01 --epoch 1 --rl_ddl 200 --batch_size 32 > res-mlp-mnist-5-seed5.log 2>&1 &
