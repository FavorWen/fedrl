...
# nohup python main_rpm.py --history_dim 8 --client_nums 100 --participant_nums 25 --seed 5 --dataset FMNIST --arch CNN --partition iid --optimizer SGD  --lr 0.01 --epoch 1 --rl_ddl 200 --batch_size 32 > res-cnn-fmnist-100-4-seed5.log 2>&1 &
