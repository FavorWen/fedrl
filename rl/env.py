...
class Env:
    def __init__(self, obs_dim, arch_name, client_nums, participant_nums, dataset_name, partition, seed, device, criterion, log_saver:LogSaver, optimizer="SGD", lr=0.01, epoch=1, rl_ddl = 100, batch_size=32, dst_path='/root/autodl-tmp/datasets2'):
