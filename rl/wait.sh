    ...
    do
        ...
        do
            ...
            for seed in "${seeds[@]}"; do
                nohup python main_rpm.py --history_dim $hdim --client_nums $c --participant_nums $p --seed $seed --dataset $dataset --arch $arch --partition $part --optimizer SGD --lr 0.01 --epoch 1 --rl_ddl 200 --batch_size 32 > res-${arch}-${c}-seed${seed}.log &
